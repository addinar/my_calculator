...
class Calculator: # defining the calculator class
    def __init__(self): #default constructor
        ...
        self.e = tk.Entry(self.root, width=50) #declares the entry
        ...
        for button in self.buttons:
            text, row, col = button
            self.create_button(self.root, text, row + 1, col)

    def create_button(self, text, row, col):
        btn = tk.Button(self.root, text=text,width=2,height=4,command=lambda t=text: self.clicker(t))
